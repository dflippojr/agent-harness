...
| --- | --- | --- |
| 1.9 | 2026-09-19 | Smart-approval effective mode: last writer among PUT and Settings; `off` is truly off |
| 1.8 | 2026-09-18 | Owner smart-approvals status and live mode (`off`/`shadow`/`auto`) |
